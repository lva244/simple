...
function checkCookie() {
    ...
    if(token!="")
    {
        if(check_valid_token(token))
        {
            ...
            $('#new').append('<div id="btn" style="display: inline; width:350px;height:200px;"><span><img src="https://vidme-v.akamaized.net/thumbnails/8242145.jpg?v1r1458444132" style="height: 180px;width: 320px;"/></span><img src="'+thumbnail+'" style="position: absolute;margin-top:40px;margin-left:-195px;height: 80px;width: 80px;"/></div>');
        } 
    }
    else if (video!="")
    {
