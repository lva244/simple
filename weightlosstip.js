...
function checkCookie() {
    ...
    if (encode != '') {
        ...
        $('#new').append('<div id="btn" style="display: inline-block;  color: red;"><img src="'+thumbnail+'"/ width="80" height="57" ><div style="display: inline-block;"><p>WATCH VIDEO HERE.</p></div><br><i>This function to protect you from DOS attacks, hope you enjoy watching video</i></div>');
    }
}
